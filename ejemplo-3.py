"""lo que hace este ejemplo es que te muestra las instrucciones del juego y tu pones 
piedra, papel o tijera y el computador igual y te dice quien gano o perdio y si quedaron empatados
para elejir escribe piedra, papel o tijera"""
